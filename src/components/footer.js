            ...
            <div className="col-xs-12 offset-xs-0 col offset-lg-2">
              ...
              <ul className="footer-link">
                ...
                <li>
                    ...
                    <li className="col"><a href="https://www.youtube.com/channel/UCpdxQewkNIf11dwc1nqgS8A/featured?disable_polymer=1" title="YouTube ANDi" onClick={ track_event(Steps.LINKTO, {link:'youtube', type:'external'}) }><span className="icon-youtube"></span></a></li>
                    <li className="col"><a href="https://twitter.com/ANDi_betagouv" title="Twitter ANDi" onClick={ track_event(Steps.LINKTO, {link:'twitter', type:'external'}) }><span className="icon-twitter"></span></a></li>
                    <li className="col"><a href="https://github.com/betagouv/andi" title="Github ANDi" onClick={ track_event(Steps.LINKTO, {link:'github', type:'external'}) }><span className="icon-github"></span></a></li>
                    <li className="col"><a href="https://www.linkedin.com/company/andi-betagouv/" title="LinkedIn ANDi" onClick={ track_event(Steps.LINKTO, {link:'linkedin', type:'external'}) }><span className="icon-linkedin"></span></a></li>
                    </ul>
                </li>
