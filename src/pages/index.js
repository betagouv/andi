        ...
        <section className="section section-grey" role="banner">
          <div className="row">
            <div className="container text_1">
              <h1 id="hero_title">Essayez un métier simplement</h1>
              <h2 id="hero_subtitle">Vous êtes en situation de handicap et vous souhaitez prendre ou reprendre contact avec la vie professionnelle ? Participez à notre expérience</h2>
              <Link id="hero_button" className="button large" to="/inscription">Je m'inscris</Link>
            </div>
